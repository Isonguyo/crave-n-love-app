      ...
      <div className="container mx-auto px-5 lg:px-8 py-14 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display text-xl">Crave <span className="text-gold">n</span> Love</span>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-center gap-2"><Phone className="h-3.5 w-3.5 text-gold" /> +234 913 757 3517</li>
            <li className="flex items-center gap-2"><MapPin className="h-3.5 w-3.5 text-gold" /> Calabar, Nigeria</li>
            <li className="flex items-center gap-2"><Instagram className="h-3.5 w-3.5 text-gold" /> @cravenlove</li>
          </ul>
        </div>
      </div>
